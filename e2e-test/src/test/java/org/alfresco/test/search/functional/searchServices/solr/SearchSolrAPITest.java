...
{
    @Test(groups = { TestGroup.SEARCH, TestGroup.REST_API}, priority = 1)
    ...
    @Test(groups = { TestGroup.SEARCH, TestGroup.REST_API}, priority = 2)
    ...
    @Test(groups = { TestGroup.SEARCH, TestGroup.REST_API }, priority = 3)
    ...
    @Test(groups = { TestGroup.SEARCH, TestGroup.REST_API }, priority = 4)
    ...
    @Test(groups = { TestGroup.SEARCH, TestGroup.REST_API }, priority = 5)
